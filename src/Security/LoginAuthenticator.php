...
class LoginAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    public function __construct(EntityManagerInterface $entityManager, UrlGeneratorInterface $urlGenerator, CsrfTokenManagerInterface $csrfTokenManager, UserPasswordEncoderInterface $userPasswordEncoderInterface)
    {
